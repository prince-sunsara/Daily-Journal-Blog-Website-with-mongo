...
// mongoose.connect("mongodb+srv://prince:<password>@cluster0.bbiddqc.mongodb.net/blogDB");
...
app.get("/", (req, res) => {
  ...
  Post.find({}).then((posts) => {
    console.log("Successfully add data in blogDB");
    res.render("home", {
...
app.post("/compose", (req, res) => {
  ...
  // composePostsRequests.push(composePost);
  post.save().then(() => {
    res.redirect("/");
  }).catch((err) => {
      console.log(err);
...
app.get("/posts/:postId", (req, res) => {
  ...
  // composePostsRequests.forEach((post) => {
